                ...
                Column(modifier = Modifier) {
                    Row(
                        ...
                        ActionButton(text = "Push") {
                            stateStack.push(getRandomValue())
                        }
                    }
                    Row(
                        modifier = Modifier
                        ...
                        ActionButton(text = "Replace") {
                            stateStack.replace(getRandomValue())
                        }
                        ActionButton(text = "Replace All") {
                            stateStack.replaceAll(getRandomValue())
                        }
                    }
                }
            }
...
private fun getRandomValue(): String {
    return Uuid.random().toString().substringBefore('-')
}
