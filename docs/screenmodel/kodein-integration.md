...
!!! info "You can find source code for a working example [here](https://github.com/hristogochev/vortex/blob/main/sample/shared/src/commonMain/kotlin/io/github/hristogochev/vortex/sample/kodeinIntegration/KodeinIntegration.kt)."